          ...
          <Fragment key={item.name + '-' + index}>
            {item?.href ? (
                    ...
                    header={({ open, toggle }) => (
                      <div
                        ...
                        className={cn(
                          ...
                          isDropdownOpen
                            ? 'text-primary before:bg-primary before:absolute before:-start-3 before:top-2/5 before:block before:h-4/5 before:w-1 before:rounded-se-md before:rounded-ee-md 2xl:before:-start-5'
              ...
              <Title
                as="h6"
                className={cn(
                  'mb-2 truncate px-6 text-xs font-normal tracking-widest text-gray-500 uppercase 2xl:px-8',
