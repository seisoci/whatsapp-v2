...
const modalStyles = {
  ...
  overlay:
    "fixed inset-0 cursor-pointer bg-black bg-opacity-60 dark:bg-opacity-80 z-[991] duration-300 ease-in-out data-[closed]:opacity-0",
  panel:
    "m-auto w-full break-words bg-background shadow-xl z-[992] duration-300 ease-in-out data-[closed]:scale-95 data-[closed]:opacity-0",
  size: {
    sm: "max-w-sm",
    md: "max-w-lg",
    lg: "max-w-2xl",
