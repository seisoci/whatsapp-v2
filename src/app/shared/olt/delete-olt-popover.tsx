...
import { deleteOlt } from '@/lib/sanctum-api';
import toast from 'react-hot-toast';

export default function DeleteOltPopover({
  oltId,
  oltName,
  onSuccess,
}: {
      ...
      <Popover.Content className="z-10">
        {({ setOpen }) => (
          <div className="w-56 pb-2 pt-1 text-left">
            ...
            >
              <PiTrashBold className="me-1 h-[17px] w-[17px]" /> Delete OLT
            </Title>
            <Text className="mb-2 leading-relaxed text-gray-500">
              Are you sure you want to delete <strong>{oltName}</strong>?
            </Text>
