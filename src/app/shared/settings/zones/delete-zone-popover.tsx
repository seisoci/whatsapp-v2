...
import { deleteZone } from '@/lib/sanctum-api';

export default function DeleteZonePopover({
  zoneId,
  zoneName,
  onSuccess,
}: {
      ...
      <Popover.Content className="z-10">
        {({ setOpen }) => (
          <div className="w-56 pb-2 pt-1 text-left">
            ...
            >
              <PiTrashBold className="me-1 h-[17px] w-[17px]" /> Delete Zone
            </Title>
            <Text className="mb-2 leading-relaxed text-gray-500">
              Are you sure you want to delete <strong>{zoneName}</strong>?
            </Text>
